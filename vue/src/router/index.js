...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/manager',
      component: () => import('@/views/Manager.vue'),/*父组件和孩子组件的问题父组件就是大的公用的vue，children是routerview里面变换的内容，只有该部分会变化*/
      children: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'courseDetail', component: () => import('@/views/front/CourseDetail.vue'),  },
        { path: 'myCourse', component: () => import('@/views/front/MyCourse.vue'),  },
        { path: 'allCourse', component: () => import('@/views/front/Allcourse.vue'),  },
      ]
    },
